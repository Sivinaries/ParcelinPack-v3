            ...
            <div className="my-4 md:my-40 space-y-8 md:space-y-12">
                <div className="mx-4 md:mx-20">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
                        {/* FORM */}
                        <div className="bg-white p-8 rounded-xl space-y-6 shadow-xl border border-gray-200">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="rounded-lg border p-3 border-gray-300 w-full h-32 focus:outline-none focus:ring-2 focus:ring-orange-500 transition duration-200 shadow-sm"
                                        required
                                        placeholder="Tulis pesan Anda..."
                                    ></textarea>
                                </div>
                                <button type="submit" className="w-full bg-orange-500 text-white p-3 rounded-lg font-semibold hover:bg-orange-600 transition duration-300">
                                    Kirim Email
                                </button>
                            </form>
                        </div>
                        ...
                        <div className="space-y-6 my-auto">
                            <div className="grid grid-cols-2 gap-6 text-center">
                                {[ 
                                    ...
                                    <a key={idx} href={link} target="_blank" rel="noopener noreferrer" className="group block p-6 rounded-xl shadow-md bg-white border border-gray-200 hover:bg-orange-50 transition duration-300">
                                        <Icon className="w-14 h-14 mx-auto text-orange-600 group-hover:text-orange-800 transition duration-300" />
                            ...
                            <iframe
                                ...
                                className="w-full h-64 rounded-xl shadow-lg border border-gray-200"
                                loading="lazy"
                            ></iframe>
                        </div>
                    </div>
