import background from "/images/service/hero.png";
  ...
  return (
    <div className="relative w-full h-[400px] md:h-[500px] overflow-hidden">
      ...
      <div className="relative z-10 h-full p-4 xl:p-8 my-4 md:my-8 text-white">
        <h1 className="text-2xl md:text-6xl font-bold absolute bottom-48 lg:bottom-56 md:bottom-44">Layanan Kami</h1>
